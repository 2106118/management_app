...
import 'package:management_app/features/sale/sale_details_screen.dart';
...
import 'package:management_app/core/services/sales_service.dart';
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                IconButton(
                                  onPressed: () async {
                                    bool response = await ReselerService.deleteReseler(isiReseler[index].id);
                                    if (response == true) {
