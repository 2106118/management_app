...
import 'package:management_app/core/models/stock_model.dart';
import 'package:management_app/features/stock/stock_details_screen.dart';
...
import 'package:management_app/core/services/stock_service.dart';
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                IconButton(
                                  onPressed: () async {
                                    bool response = await StockService.deleteStock(isiStock[index].id);
                                    if (response == true) {
